...
(custom-theme-set-faces
 ...
 ;; - green :      "#6ac214"
 ;; - orange/red : "tomato"
 `(default ((t (:family "Monaco" :foundry "unknown" :width normal :height 150 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#eeeeec" :background "#202424" :stipple nil :inherit nil))))
